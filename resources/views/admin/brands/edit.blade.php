                                            ...
                                            <div class="form-vertical__item bg-style">
                                                ...
                                                <div class="input__group mb-25">
                                                    ...
                                                    <input type="text" id="en_brand_name" name="en_brand_name"
                                                        value="{{ $brand->en_brand_name }}" placeholder="Brand name">
                                                </div>

                                                <div class="input__group mb-25">
                                                    <label>Slug</label>
                                                    <input type="text" value="{{ $brand->slug }}" readonly>
                                                </div>
                                                ...
                                                <div class="input__group mb-25">
                                                    ...
                                                    @if($brand->image)
                                                    <img width="80" src="{{ asset('front/assets/images/brands/'.$brand->image) }}">
                                                    @endif
                                                </div>
