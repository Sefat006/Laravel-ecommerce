                ...
                <div class="login-wrap">
                    ...
                    <form method="POST" class="login-form" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            ...
                            <select name="user_type" class="form-control rounded-left @error('user_type') is-invalid @enderror" required>
                                <option value="customer" {{ old('user_type') == 'customer' ? 'selected' : '' }}>Customer</option>
                                <option value="deliveryman" {{ old('user_type') == 'deliveryman' ? 'selected' : '' }}>Delivery Man</option>
                            </select>
