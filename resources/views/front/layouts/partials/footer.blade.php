                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="single-widget">
                                    ...
                                    <ul class="widget-menu">
                                        ...
                                        <li class="menu-item">
                                            <a class="menu-link" href="{{ route('terms.conditions') }}">Terms of Conditions</a>
                                        </li>
                                        <li class="menu-item">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form onsubmit="updateAction(event)">
                        <div class="mb-3">
                            <label for="tracking" class="form-label">Order Number</label>
                            <input type="text" class="form-control" id="tracking" name="tracking_number"
    ...
    <script>
        function updateAction(event) {
            ...
            let trackingInput = document.getElementById('tracking').value.trim();
            if (trackingInput) {
                window.location.href = "{{ url('/order-tracking') }}/" + encodeURIComponent(trackingInput);
            }
        }
    </script>
