                    ...
                    <div class="product-top">
                        ...
                        <ul class="prdouct-btn-wrapper">
                            <li class="single-product-btn">
                                <a href="javascript:void()" class="product-btn addtoCompare" data-id="{{$product->id}}" title="Add To Compare"><i
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-grid-product">
                            <div class="product-top">
                                ...
                                <ul class="prdouct-btn-wrapper">
                                    <li class="single-product-btn">
                                        <a href="javascript:void()" class="product-btn addtoCompare" data-id="{{$product->id}}" title="Add To Compare"><i class="icon flaticon-bar-chart"></i></a>
                                    </li>
                                    <li class="single-product-btn">
                                        <a href="javascript:void()" class="product-btn addtoWishlist" data-id="{{$product->id}}" title="Add To Wishlist"><i
                                                class="icon flaticon-like"></i></a>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-grid-product">
                            <div class="product-top">
                                ...
                                <ul class="prdouct-btn-wrapper">
                                    <li class="single-product-btn">
                                        <a href="{{ route('compare.add', $product->id) }}" href="{{ route('compare.add', $product->id) }}" class="product-btn CompareList" data-id="11" title="Add To Compare"><i
                                                class="icon flaticon-bar-chart"></i></a>
                                    </li>
                                    <li class="single-product-btn">
                                        <a href="javascript:void()" class="product-btn addtoWishlist" data-id="{{$product->id}}" title="Add To Wishlist"><i
